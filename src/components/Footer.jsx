        ...
        <div className="footer-grid">
          <div className="footer-col about-col">
            ...
            <div className="social-links">
              <a href="https://www.facebook.com/bluecraftdesignstudio/" target="_blank" rel="noopener noreferrer" aria-label="Facebook"><FacebookIcon /></a>
              <a href="https://x.com/BlueCraft9999" target="_blank" rel="noopener noreferrer" aria-label="Twitter"><TwitterIcon /></a>
              <a href="https://www.instagram.com/blue_craft_design_studio/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><InstagramIcon /></a>
              <a href="https://www.linkedin.com/company/blue-craft-design-studio/posts/?feedView=all" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><LinkedinIcon /></a>
            </div>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul className="contact-list">
              <li>
                ...
                <span>club circle 754/1, 19 th main, 22nd Cross Rd, Sector 2, HSR Layout, Bengaluru, Karnataka 560102</span>
              </li>
              <li>
